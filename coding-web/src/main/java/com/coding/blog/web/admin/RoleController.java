...
public class RoleController {
    ...
    public ResultObject deleteRoleById(@RequestParam Long roleId){
    ...
    public ResultObject listMenu(@RequestParam Long roleId){
        ...
        if (!menus.isEmpty()) return ResultObject.success(menus);
        return ResultObject.failed();
    }
    ...
    public ResultObject listResource(@RequestParam Long roleId){
        ...
        if (!resources.isEmpty()) return ResultObject.success(resources);
        return ResultObject.failed();
    }
