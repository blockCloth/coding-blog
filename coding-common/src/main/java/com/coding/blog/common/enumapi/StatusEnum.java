...
public enum StatusEnum {
    ...
    // 系统-角色相关异常
    SYSTEM_ROLE_NOT_EXISTS(300_404_001,"角色不存在，请联系管理员！:%s"),
    SYSTEM_ROLE_EXISTS(300_404_002,"角色已存在，请勿重试！:%s"),
    //系统-菜单相关异常
    SYSTEM_MENU_NOT_EXISTS(300_404_003,"菜单不存在，请联系管理员！:%s"),
    SYSTEM_MENU_EXISTS(300_404_006,"菜单已存在！:%s"),
    SYSTEM_MENU_IS_CHILDREN(300_404_008,"存在子菜单，禁止删除！:%s"),

    //系统-资源相关异常
    SYSTEM_RESOURCE_NOT_EXISTS(300_404_004,"资源不存在，请联系管理员！:%s"),
    SYSTEM_RESOURCE_EXISTS(300_404_005,"资源已存在！:%s"),
    SYSTEM_DATA_USE(300_500_001,"资源已被使用，请勿重试！:%s"),
    //系统-资源分类相关异常
    SYSTEM_RESOURCE_CATEGORY_EXISTS(300_404_007,"该源分类已存在！:%s"),
    ...
    LOGIN_FAILED_NOT_OLDPASS(400_500_002,"旧密码输入错误，请重新输入:%s"),
    // 待审核
    USER_NOT_AUDIT(400_500_002, "用户未审核:%s");
